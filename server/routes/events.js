...
router.post('/', requireAdmin, async (req, res) => {
  try {
    ...
    const result = await pool.query(
      ...
      [title, description, date, time, location, city, category, image_url, req.user.id, rating || 5.0, latitude || null, longitude || null, price !== undefined ? price : 5000]
    );
...
router.put('/:id', requireAuth, async (req, res) => {
  try {
    ...
    await pool.query(
      ...
      [title, description, date, time, location, city, category, image_url, latitude || null, longitude || null, price !== undefined ? price : 5000, req.params.id]
    );
