      ...
      <div className="glass-card" style={{ padding: '40px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '24px' }}>
          ...
          <div>
            ...
            <input type="number" name="price" className="input-field" value={formData.price || 5000} onChange={handleChange} placeholder={t('price_placeholder')} />
          </div>
            ...
            {formData.sessions && formData.sessions.map((session, idx) => (
              <div key={idx} style={{ padding: '16px', background: 'var(--card-bg)', borderRadius: '14px', border: '1px solid var(--border-color)', marginBottom: '15px', position: 'relative', boxShadow: '0 4px 10px rgba(0,0,0,0.05)' }}>
                ...
                <div>
                  ...
                  <input type="text" className="input-field" value={session.coordinatesStr || ''} onChange={(e) => handleSessionChange(idx, 'coordinatesStr', e.target.value)} placeholder={t('coordinates_example')} style={{ padding: '10px' }} />
                </div>
              </div>
            ))}
          </div>
